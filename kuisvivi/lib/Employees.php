...
class Employees{
	...
	function create(){
        $count= count($this->ambilDataEmployees($this->employee_id));
        if ($count>0){
            http_response_code(503);
            return array('msg' => "Data Sudah Ada Di DataBase" );
        }
        else if ($this->employee_id == null){
            http_response_code(503);
            return array('msg' => "Kode Tidak Boleh Kosong, Gagal Simpan Ke database!" );
        } else {
            ...
            if ($hasil){
                ...
                return array('msg'=>'Data Sukses Disimpan');
            } else {
                http_response_code(503);    
    ...
    function getAll(){
        ...
        return $data;
		 ...
		 function ambilDataEmployees($employee_id){
        // return "test";
